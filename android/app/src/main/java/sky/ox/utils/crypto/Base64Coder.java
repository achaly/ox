package sky.ox.utils.crypto;

/**
 * <p> Encodes and decodes to and from Base64Coder notation. </p> <p> Homepage: <a
 * href="http://iharder.net/base64">http://iharder.net/base64</a>. </p> <p>
 * Change Log: </p> <ul> <li>v2.2.1 - Fixed bug using URL_SAFE and ORDERED
 ...
 * encoding/decoding from one file to the next. Also added these Base64Coder
 * dialects: <ol> <li>The default is RFC3548 format.</li> <li>Calling
 * Base64Coder.setFormat(Base64Coder.BASE64_FORMAT.URLSAFE_FORMAT) generates URL and file
 * name friendly format as described in Section 4 of RFC3548.
 * http://www.faqs.org/rfcs/rfc3548.html</li> <li>Calling
 * Base64Coder.setFormat(Base64Coder.BASE64_FORMAT.ORDERED_FORMAT) generates URL and file
 ...
 * for contributing the new Base64Coder dialects.</li> <li>v2.1 - Cleaned up javadoc
 * comments and unused variables and methods. Added some convenience methods for
 * reading and writing to and from files.</li> <li>v2.0.2 - Now specifies UTF-8
 * encoding in places where the code fails on systems with other encodings (like
 * EBCDIC).</li> <li>v2.0.1 - Fixed an error when decoding a single byte, that
 * is, when the encoded data was a single byte.</li> <li>v2.0 - I got rid of
 * methods that used booleans to set options. Now everything is more
 * consolidated and cleaner. The code now detects when data that's being decoded
 * is gzip-compressed and will decompress it automatically. Generally things are
 * cleaner. You'll probably have to change some method calls that you were
 * making to support the new options format (<tt>int</tt>s that you "OR"
 * together).</li> <li>v1.5.1 - Fixed bug when decompressing and decoding to a
 * byte[] using <tt>decode( String s, boolean gzipCompressed )</tt>. Added the
 * ability to "suspend" encoding in the Output Stream so you can turn on and off
 * the encoding if you need to embed base64 data in an otherwise "normal" stream
 * (like an XML file).</li> <li>v1.5 - Output stream pases on flush() command
 * but doesn't do anything itself. This helps when using GZIP streams. Added the
 * ability to GZip-compress objects before encoding them.</li> <li>v1.4 - Added
 * helper methods to read/write files.</li> <li>v1.3.6 - Fixed
 * OutputStream.flush() so that 'position' is reset.</li> <li>v1.3.5 - Added
 * flag to turn on and off line breaks. Fixed bug in input stream where last
 * buffer being read, if not completely full, was not returned.</li> <li>v1.3.4
 * - Fixed when "improperly padded stream" error was thrown at the wrong
 * time.</li> <li>v1.3.3 - Fixed I/O streams which were totally messed up.</li>
 * </ul> <p> I am placing this code in the Public Domain. Do with it as you
 * will. This software comes with no guarantees or warranties but with plenty of
 * well-wishing instead! Please visit <a href="http://iharder.net/base64">http://iharder.net/base64</a>
...
public class Base64Coder {
    ...
    /**
     * Encode using Base64Coder-like encoding that is URL- and Filename-safe as
     * described in Section 4 of RFC3548: <a href="http://www.faqs.org/rfcs/rfc3548.html"
     * >http://www.faqs.org/rfcs/rfc3548.html</a>. It is important to note that
     * data encoded this way is <em>not</em> officially valid Base64Coder, or at the
     * very least should not be called Base64Coder without also specifying that is
     * was encoded using the URL- and Filename-safe dialect.
     */
    public final static int URL_SAFE = 16;

    /**
     * Encode using the special "ordered" dialect of Base64Coder described here: <a
    ...
    /**
     * Translates a Base64Coder value to either its 6-bit reconstruction value or a
     ...
     * RFC3548: <a href="http://www.faqs.org/rfcs/rfc3548.html">http://www.faqs.org
     ...
     * returns a four-byte array in Base64Coder notation. The actual number of
     ...
     * the resulting four Base64Coder bytes to <var>destination</var>. The source and
    ...
    /**
     * Serializes an object and returns the Base64Coder-encoded version of that
     ...
     * </pre>
     * <p> Example: <code>encodeObject( myObj, Base64Coder.GZIP )</code> or <p>
    ...
    /**
     * Encodes a byte array into Base64Coder notation. <p> Valid options:
     *
     * <pre>
     *   GZIP: gzip-compresses object before encoding it.
     *   DONT_BREAK_LINES: don't break lines at 76 characters
     *     <i>Note: Technically, this makes your encoding non-compliant.</i>
     * </pre>
     * <p> Example: <code>encodeBytes( myData, Base64Coder.GZIP )</code> or <p>
     ...
     * Base64Coder encoding. <p> This is the lowest level of the decoding methods
    ...
    /**
     * Decodes data from Base64Coder notation, automatically detecting
    ...
    /**
     * Attempts to decode Base64Coder data and deserialize a Java Object within.
    ...
    public static String encodeFromFile(String filename, int option) {
        ...
        try {
            ...
            bis = new Base64Coder.InputStream(
                    new java.io.BufferedInputStream(
                            new java.io.FileInputStream(file)), option);
     ...
     * to/from Base64Coder notation on the fly.
     *
     * @see Base64Coder
     * @since 1.3
     */
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link Base64Coder.InputStream} in either ENCODE or DECODE
         ...
         * non-compliant.</i>
         * </pre>
         * <p> Example: <code>new Base64Coder.InputStream( in, Base64Coder.DECODE
         * )</code>
         *
        ...
        /**
         * Reads enough of the input stream to convert to/from Base64Coder and
     ...
     * encode/decode to/from Base64Coder notation on the fly.
     *
     * @see Base64Coder
     * @since 1.3
     */
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link Base64Coder.OutputStream} in either ENCODE or DECODE
         * mode. <p> Valid options:
         *
         * <pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.
         ...
         * non-compliant.</i>
         * </pre>
         * <p> Example: <code>new Base64Coder.OutputStream( out, Base64Coder.ENCODE
         * )</code>
         *
        ...
        /**
         * Writes the byte to the output stream after converting to/from Base64Coder
