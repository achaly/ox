...
//    public Status(AVStatus status) {
//        parseFromAVStatus(status);
//    }

//    private void parseFromJSONObject(JSONObject object) {
//        String inbox = (String) object.opt(INBOX_TYPE_KEY);
//        switch (inbox) {
//            case InboxType.ALL:
...
//        }
//
//        String sType = (String) object.opt(STATUS_TYPE_KEY);
//        switch (sType) {
//            case StatusType.IMAGE:
//                this.statusType = StatusType.IMAGE;
//                Observable.from(IMAGE_KEY)
//                        .map(new Func1<String, String>() {
//                            @Override
//                            public String call(String key) {
//                                return (String) object.opt(key);
//                            }
//                        })
...
//                this.video = (String) object.opt(VIDEO_KEY);
//                break;
//
//            case StatusType.AUDIO:
//                this.statusType = StatusType.AUDIO;
//                this.audio = (String) object.opt(AUDIO_KEY);
//                break;
//
...
//        }
//
//        this.title = (String) object.opt(TITLE_KEY);
//        this.message = (String) object.opt(MESSAGE_KEY);
//        this.source = null;
//    }

//    private void parseFromAVStatus(AVStatus status) {
//        String inbox = status.getInboxType();
//        switch (inbox) {
//            case InboxType.ALL:
//                this.inboxType = InboxType.ALL;
//                break;
...
//        }
//
//        String sType = (String) status.get(STATUS_TYPE_KEY);
//        switch (sType) {
//            case StatusType.IMAGE:
//                this.statusType = StatusType.IMAGE;
//                Observable.from(IMAGE_KEY)
...
//            case StatusType.VIDEO:
//                this.statusType = StatusType.VIDEO;
//                this.video = (String) status.get(VIDEO_KEY);
//                break;
//
//            case StatusType.AUDIO:
//                this.statusType = StatusType.AUDIO;
//                this.audio = (String) status.get(AUDIO_KEY);
//                break;
//
//            case StatusType.TEXT:
//                this.statusType = StatusType.TEXT;
...
//        }
//
//        this.title = (String) status.get(TITLE_KEY);
//        this.message = status.getMessage();
//        this.source = new User(status.getSource());
//
//    }
...
//    public AVStatus toAVStatus() {
//        AVStatus status = new AVStatus();
//        status.setInboxType(this.inboxType);
//
//        status.put(STATUS_TYPE_KEY, this.statusType);
//        switch (this.statusType) {
//            case StatusType.IMAGE:
//                Observable.zip(Observable.from(IMAGE_KEY), Observable.from(this.images), new Func2<String, String, Object>() {
//                    @Override
//                    public Object call(String key, String image) {
//                        status.put(key, image);
//                        return null;
//                    }
//                }).subscribe();
//                break;
//
//            case StatusType.VIDEO:
//                status.put(VIDEO_KEY, this.video);
//                break;
//
//            case StatusType.AUDIO:
//                status.put(AUDIO_KEY, this.audio);
//                break;
//        }
//
//        if (!TextUtils.isEmpty(this.title)) {
//            status.put(TITLE_KEY, this.title);
//        }
//
//        if (!TextUtils.isEmpty(this.message)) {
